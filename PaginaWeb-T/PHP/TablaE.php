        ...
        <div class="table-wrapper">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <td>
                        <a href="EUpdate.php?id=<?php echo $idEmpleado;?>" class="edit" title="Editar" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                        <a href="Edelete.php?id=<?php echo $idEmpleado;?>" class="delete" title="Eliminar" data.toogle="tooltip"><i class="material-icons">&#xE872;</i></a>
                    </td>
                </tr>
